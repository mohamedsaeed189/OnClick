...
const handleSubmit = async (e)=>{
  ...
  const response = await fetch("/individualTrainees/"+userId+"/addReports", {
      method: "POST",
  ...
  if(response.ok){
    ...
    useEffect(()=>{
        ...
        const fetchReports = async ()=>{
            const response = await fetch ('/individualTrainees/'+userId+'/reports')
            const json = await response.json()
...
export default ViewMyReportsIT