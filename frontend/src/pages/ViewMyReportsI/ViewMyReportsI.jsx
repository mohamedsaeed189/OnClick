  ...
  if(response.ok){
    ...
    useEffect(()=>{
        ...
        const fetchReports = async ()=>{
            const response = await fetch ('/instructors/'+userId+'/reports')
            const json = await response.json()
    ...
    return(
        ...
        <div className="all-reports" style={{ marginLeft:"20px",minHeight:"70vh"}}>
    ...
    {isOpen && <Popup 
      content={<>
              <div style={{fontSize:"20px",color:"#606060",marginLeft:"-150px"}} >Complaint</div>
...
<br></br>
        ...
        <br></br>
        <button style={{marginTop:"10px", marginLeft:"510px",fontsize:"80px"}} className="yaybtn" >Add</button>
        {error && <p>{error}</p>}
